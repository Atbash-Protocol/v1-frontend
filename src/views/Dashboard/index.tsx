...
function Dashboard() {
    ...
    const DashboardItems = [
        ...
        { name: "BashPrice", value: formatUSD(app.marketPrice, 2) },
        { name: "wsBASHPrice", value: formatUSD(app.marketPrice * Number(app.currentIndex), 2) },
        { name: "MarketCap", value: formatUSD(app.marketCap) },
        { name: "TVL", value: formatUSD(app.stakingTVL) },
